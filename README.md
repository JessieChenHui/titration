...
<img src="./docs/images/results_AT.png" style="width: 50%; height: auto;">  
...
部分甲基红手动滴定视频见 <https://pan.baidu.com/s/13zdyUjJn7UOU4EV6pfhzXQ?pwd=pv2y> 提取码: pv2y

# 四、其它说明
1）项目中的模型说明参见"./outputs/checked/readme.txt"。  
2）tools目录中的python程序用于"从视频中抽取图片"、"打标生成用于分类的labels"  
